(function() {
  ...
  UserService = (function() {
    ...
    UserService.prototype.deleteUser = function(idNumber, user) {
      var deferred;
      this.$log.debug("deleteUser " + (angular.toJson(user, true)));
      deferred = this.$q.defer();
      this.$http.put("/user/" + idNumber, user).success((function(_this) {
        return function(data, status, headers) {
